...
Last session: 24/07/2026 (noite) — **Rodapé (footer) público: Report a Bug / Contact / Career + páginas legais placeholder** (branch `feat/app-footer-contact-legal`, a partir de `main`).
