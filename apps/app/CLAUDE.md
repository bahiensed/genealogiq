...
Last session: 25/07/2026 — **Árvore Genealógica: polish/bugs da Fase 2 + Sign-up frictionless** (branch `feat/app-geolocations-plural`, continuação — mistura Places de sessão anterior + polish da árvore + auth desta sessão, nada commitado ainda).
