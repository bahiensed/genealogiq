...
function ActionsCell({ row, currentUserRole }: { row: { original: SupplierCategoryRow }; currentUserRole: string }) {
...
export function getColumns(currentUserRole: string): ColumnDef<SupplierCategoryRow>[] {
  return [
    {
      accessorKey: 'name',
