...
export default function TermsPage() {
  return (
    <article className="prose prose-neutral dark:prose-invert max-w-4xl mx-auto">
      ...
      <p className="mb-10">
        By accessing or using <strong>B2C Boilerplate</strong> ("Service"), you agree to
      ...
      <ul className="mb-10">
        ...
        <li>Immediately notify any unauthorized use of your account.</li>
      ...
      <p className="mb-4">
        You may delete your account at any time in your profile settings. After deletion,
        your personal data will be permanently removed, as described in our Privacy Policy.
      </p>
      ...
      <p className="mb-10">
        ...
        for interruptions, data loss, or indirect damages arising from use of the Service.
      </p>
      ...
      <h2 className="mb-2">VIII. Jurisdiction and Applicable Law</h2>

      <p className="mb-10">
        These Terms are governed by the laws of the Federative Republic of Brazil. The courts
        of [CITY/STATE] shall have exclusive jurisdiction to resolve any disputes.
      </p>
