...
import { SquarePen, Quote } from "lucide-react"
import {
  Carousel,
  CarouselContent,
  CarouselItem,
      ...
      <main className="container relative pt-24 pb-32 max-w-5xl">
        <section className="mb-8 flex items-end justify-between gap-4 animate-fade-in">
          <div>
            ...
            <p className="text-muted-foreground mt-2">A life remembered through words and images.</p>
          </div>
          <Button asChild className="shrink-0 gap-2">
            <Link href="/profile/bio/edit">
        ...
        {isEmpty ? (
          ...
          >
            ...
            <Button asChild variant="outline" size="sm">
              <Link href="/profile/bio/edit">Create biography</Link>
            </Button>
          </div>
        ) : (
          <>
