...
// 32 characters = 5 bits each; 16 bytes → 16 chars × 5 bits = 80 bits of
// entropy. 256 % 32 === 0, so there is no modulo bias.
const ALPHABET = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789"

/** Cryptographically random 16-character URL-safe license code. */
