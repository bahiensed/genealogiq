// Pure, framework-free BR/intl document & contact masks + validators. Single
// source of truth for all three apps (the CPF/CNPJ validators are security-
// relevant input validation — they must not drift between app copies). App-
// specific masks (currency, per-country phone) stay in each app's lib/masks.
